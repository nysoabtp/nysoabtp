...
async function loadAchatsTable() {
    ...
    if (typeof currentChantierFilter !== 'undefined' && currentChantierFilter) {
        if (typeof filterTableByChantier === 'function') filterTableByChantier('achats-table', currentChantierFilter);
    }
}
...
async function loadPersonnelTable() {
    ...
    // Ré-appliquer le filtre chantier actif s'il y en a un
    if (typeof currentChantierFilter !== 'undefined' && currentChantierFilter) {
        if (typeof filterTableByChantier === 'function') filterTableByChantier('personnel-table', currentChantierFilter);
    }
}
